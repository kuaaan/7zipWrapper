...
{
    xErrorLog(L"[7z.dll][GetHandlerProperty2]");
    xErrorLog(L"\t[IN] formatIndex : %d", formatIndex);
    xErrorLog(L"\t[IN] propID : %d", propID);
    xErrorLog(L"\t[OUT] pPROPVARIANT *value");
...
{
    xErrorLog(L"[7z.dll][GetNumberOfFormats]");
    xErrorLog(L"\t[OUT] numFormats : %d", g_NumArcs);
...
{
    xErrorLog(L"[7z.dll][GetIsArc]");
    xErrorLog(L"\t[IN] formatIndex : %d", formatIndex);
    xErrorLog(L"\t[OUT] Func_IsArc *isArc");
